=== WP Content Filter ===
Contributors: dgwyer
Tags: banned, replace, words, edit, content filter, filter, filtered, content censor, censor, censored, keywords, options, profanity, swearing, post, admin, abuse, explicit, seo
