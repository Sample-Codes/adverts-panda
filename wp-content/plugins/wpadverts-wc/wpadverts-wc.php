...
//            echo "<pre>";print_r($current_wallet_price); die;
//            if( $product->get_price() == 0 ) {
                ...
                $duration = absint( get_post_meta( $product->ID, 'adverts_visible', true ) );

                $save_time = date('d-m-Y',get_post_meta($post_id, "_expiration_date", true));
                $time = strtotime( $save_time . " +" . $duration . " DAYS" );
